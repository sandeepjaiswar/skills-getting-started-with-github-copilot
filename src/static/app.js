  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        // Build participants HTML (bulleted list or placeholder) with delete buttons
        ...
        // Attach delete handlers for any delete buttons inside this card
        const deleteButtons = activityCard.getElementsByClassName('participant-delete');
